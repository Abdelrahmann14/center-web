  ...
  return (
    <div dir="rtl" className={`w-full ${className}`}>
      <div className="flex items-baseline justify-between gap-3">
        ...
        <span
          aria-hidden
          className="grid shrink-0 justify-items-start text-slate-500 dark:text-slate-400"
        >
          <motion.span
      ...
      <div
        ...
        aria-valuemax={max}
        {...measured}
        className="mt-2 rounded-[4px] bg-slate-200/70 p-[2px] shadow-[inset_0_1px_2px_rgba(15,23,42,0.1),inset_0_0_0_1px_rgba(15,23,42,0.06)] dark:bg-[#12212a] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.45)]"
      >
        <div className="relative h-[8px] overflow-hidden rounded-[2px]">
          <motion.span
            aria-hidden
            className="absolute inset-0 block origin-right rounded-[2px] bg-[#3B7A8C] shadow-[inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1px_0_rgba(15,23,42,0.2)] dark:bg-[#5b97a8] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(0,0,0,0.25)]"
            initial={false}
          ...
          {indeterminate && !reduced ? (
            <motion.span
              aria-hidden
              className="absolute inset-y-0 right-0 block w-2/5 rounded-[2px] bg-[#3B7A8C] shadow-[inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1px_0_rgba(15,23,42,0.2)] dark:bg-[#5b97a8] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.35),inset_0_-1px_0_rgba(0,0,0,0.25)]"
